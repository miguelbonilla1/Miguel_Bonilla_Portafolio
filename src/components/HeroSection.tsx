...
export default function HeroSection() {
  return (
    <section id="HeroSection" className="relative w-full min-h-screen overflow-hidden bg-gradient-to-r from-gray-800 via-gray-900 to-black">
      <AnimatedBackground />
      <div className="relative z-20 flex flex-col-reverse lg:flex-row items-center justify-center min-h-screen px-4 lg:px-36 py-12">
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end mb-8 ">
